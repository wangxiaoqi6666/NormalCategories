...
+ (NSString *)xn_platformString{
    NSString *platform = [self xn_platform];
...
+ (NSUInteger)xn_getSysInfo:(uint)typeSpecifier
{
...
+ (NSUInteger)xn_cpuFrequency {
    return [self xn_getSysInfo:HW_CPU_FREQ];
}

+ (NSUInteger)xn_busFrequency {
    return [self xn_getSysInfo:HW_BUS_FREQ];
}

+ (NSUInteger)xn_ramSize {
    return [self xn_getSysInfo:HW_MEMSIZE];
}

+ (NSUInteger)xn_cpuNumber {
    return [self xn_getSysInfo:HW_NCPU];
}


+ (NSUInteger)xn_totalMemoryBytes
{
    return [self xn_getSysInfo:HW_PHYSMEM];
}
